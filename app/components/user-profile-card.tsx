  ...
  return (
    <Card>
      <CardHeader className='flex flex-row  items-center justify-between space-y-4'>
        ...
        <UserPrimaryImageCard avatarUrl={userProfile.avatarUrl} />
      </CardHeader>
      <CardContent>
        <div className='flex flex-col space-y-4'>
          <UserImagesCard />
...
const UserPrimaryImageCard = ({ avatarUrl }: { avatarUrl: string | null }) => {
  return (
    <div className='flex flex-col space-y-4 border-2 border-purple-700'>
      {avatarUrl ? (
        <img
          src={avatarUrl}
          alt='User Avatar'
        ...
        <div className='h-20 w-20 bg-purple-700 flex items-center justify-center rounded-full'>
          <UserPlaceHolder />
        </div>
      )}
    </div>
    ...
    <div className='flex flex-col space-y-4'>
      ...
      <CardContent>
        <div className='grid grid-cols-3 gap-4'>
          <div className='bg-gray-300 h-32'>Image</div>
          <div className='bg-gray-300 h-32'>Image</div>
          <div className='bg-gray-300 h-32'>Image</div>
        </div>
      </CardContent>
